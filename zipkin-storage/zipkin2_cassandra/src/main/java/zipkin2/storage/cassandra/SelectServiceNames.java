...
@AutoValue
abstract class SelectServiceNames extends ResultSetFutureCall {
  static class Factory {
    ...
    Call<List<String>> create() {
      return new AutoValue_SelectServiceNames(session, preparedStatement)
        .flatMap(accumulateServicesIntoSet);
    }
  }
