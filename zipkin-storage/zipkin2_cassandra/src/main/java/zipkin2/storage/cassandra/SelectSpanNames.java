...
@AutoValue
abstract class SelectSpanNames extends ResultSetFutureCall {
  static class Factory {
    ...
    Factory(Session session) {
      ...
      this.preparedStatement = session.prepare(
        QueryBuilder.select("span").from(TABLE_SERVICE_SPANS)
    ...
    Call<List<String>> create(String serviceName) {
      ...
      return new AutoValue_SelectSpanNames(session, preparedStatement, service)
        .flatMap(accumulateNamesIntoSet);
    }
  }
